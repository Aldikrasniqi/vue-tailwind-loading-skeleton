			...
			<div class="hidden w-full md:block md:w-auto" id="navbar-default">
				...
				>
					<li
						...
						:key="link.path"
						:class="{
							'text-blue-700 dark:text-blue-500 bg-blue-100 dark:bg-blue-900 md:bg-transparent md:dark:bg-transparent':
								route.path === link.path,
							'text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100':
								route.path !== link.path,
						}"
					>
						<router-link :to="link.path" class="block py-2 px-3 rounded">
							{{ link.name }}
						</router-link>
					</li>
				</ul>
